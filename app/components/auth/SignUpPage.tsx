...
export default function SignUpPage() {
  ...
  return (
    <form onSubmit={signUpToApp} className="flex-1 flex flex-col justify-center items-center  bg-main-gray overflow-hidden">
      <div className="flex flex-col justify-center items-center w-[900px] h-[900px]  bg-header-gray">
        ...
        <input
          ...
          className="outline-header-gray w-full text-header-main text-center"
        />
        {errors.email && (<p className="text-error text-size-error">{errors.email}</p>)}
        ...
        <input
          ...
          className="outline-header-gray w-full text-header-main  text-center"
        />
        {errors.confirmPassword && (<p className="text-error text-size-error">{errors.confirmPassword}</p>)}
        <button
          type="submit"
        ...
        {errors.signUpError && (<p className="text-error text-size-error">{errors.signUpError}</p>)}
